"""Views for the user_messages app."""
...
class MessageInboxView(LoginRequiredMixin, ListView):
    """View for displaying the user's inbox of received messages."""
    model = Message
...
class MessageDetailView(LoginRequiredMixin, UserPassesTestMixin, DetailView):
    ...
    def get(self, request, *args, **kwargs):
        """Handle GET request and mark message as read if user is receiver."""
